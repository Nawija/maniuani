...
const IndexPage = () => {
    ...
    return (
        <Layout>
            <Slider
                {...settings}
                className="relative overflow-hidden max-w-[2200px] mx-auto"
            >
            ...
            <div class="flex flex-col items-center justify-between gap-8 md:flex-row max-w-screen-xl mx-auto">
                <div class="flex h-12 w-64 divide-x divide-pink-200 overflow-hidden">
                    <a
                        href="#"
                        class="flex w-1/3 items-center justify-center text-gray-500 transition-colors hover:bg-pink-100 active:bg-gray-200"
                    >
                        Men
                    </a>
                    <a
                ...
                <div class="flex items-center justify-center gap-4 lg:justify-start">
                    ...
                    <span class="h-px w-12 bg-pink-200"></span>

                    <div class="flex gap-4">
                        <a
                            href="#"
                            target="_blank"
                            class="text-gray-400 transition hover:text-pink-400 active:text-gray-600"
                        >
                            <svg
                                class="h-5 w-5"
                                width="24"
                        ...
                        <div>
                            ...
                            <div class="flex items-start justify-between gap-2 px-2">
                                <div class="flex flex-col">
                                    <a
                                        href="#"
                                        class="text-lg font-bold text-gray-800 transition hover:text-pink-400 lg:text-xl"
                                    >
                                        Fancy Outfit
                                    </a>
                ...
                <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div class="flex flex-col overflow-hidden rounded-lg bg-gray-200 sm:flex-row md:h-80">
                        <div class="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-2/5">
                            ...
                            <p class="mb-8 max-w-md text-gray-700">
                            ...
                            <div class="mt-auto">
                                <a
                                    href="#"
                                    class="inline-block rounded-lg bg-white px-8 py-3 text-center text-sm font-semibold text-gray-800 outline-none ring-indigo-300 transition hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:text-base"
                                >
                                    Zamów Teraz
                                </a>
                            </div>
                        ...
                        <div class="order-first h-48 w-full bg-gray-700 sm:order-none sm:h-auto sm:w-1/2 lg:w-3/5">
                            <img
                                src="https://img.freepik.com/darmowe-zdjecie/naturalne-traktowanie-na-stole_23-2148574957.jpg?w=2000&t=st=1693339952~exp=1693340552~hmac=939ba44d4f8c8a30de9fee8e8dbf5c54682370911d126e3362b9db0ed9b035fd"
                                loading="lazy"
            ...
            <div class="bg-white py-6 sm:py-8 lg:py-12">
                <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div class="flex flex-col items-center rounded-lg bg-gray-200 p-4 sm:p-8 lg:flex-row lg:justify-between">
                        <div class="mb-4 sm:mb-8 lg:mb-0">
                            <h2 class="text-center text-xl font-bold text-pink-500 sm:text-2xl lg:text-left lg:text-3xl">
                        ...
                        <div class="flex flex-col items-center lg:items-end">
                            <form class="mb-3 flex w-full max-w-md gap-2">
                                <input
                                    placeholder="Email"
                                    class="bg-gray-white w-full flex-1 rounded border border-gray-400 px-3 py-2 text-gray-800 placeholder-gray-400 outline-none ring-indigo-300 transition focus:ring"
                                />

                                <button class="inline-block rounded bg-pink-500 px-8 py-2 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">
                                    Send
                                </button>
                            </form>
                            ...
                            <p class="text-center text-xs text-gray-400 lg:text-right">
                                ...
                                <a
                                    href="#"
                                    class="underline transition hover:text-pink-500 active:text-indigo-600"
                                >
                                    Term of Service
                                </a>{" "}
                                and{" "}
